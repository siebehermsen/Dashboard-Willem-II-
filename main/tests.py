...
class DashboardPersistenceTests(TestCase):
    ...
    def test_academie_team_page_shows_team_environment(self):
        ...
        self.assertContains(response, 'data-team-gps-metric="total_distance"')
        self.assertContains(response, 'data-team-gps-metric="d15"')
        self.assertContains(response, 'data-team-gps-metric="d20"')
        self.assertContains(response, 'data-team-gps-metric="d25"')
        self.assertContains(response, 'data-team-gps-metric="accelerations"')
        self.assertContains(response, 'data-team-gps-metric="decelerations"')
        self.assertContains(response, "Metrics")
        self.assertNotContains(response, 'data-team-gps-player="team"')
