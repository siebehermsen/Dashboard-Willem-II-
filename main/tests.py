...
class DashboardPersistenceTests(TestCase):
    ...
    def test_academie_team_page_shows_team_environment(self):
        ...
        self.assertNotContains(response, 'data-team-gps-metric="total_distance"')
        self.assertNotContains(response, '<span class="gps-control-label">Metrics</span>', html=True)
        self.assertNotContains(response, "Gem. belasting")
