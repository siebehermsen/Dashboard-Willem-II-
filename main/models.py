...
class DayProgramEntry(models.Model):
    ...
    category = models.CharField(blank=True, default='training', max_length=40)
    ...
    responsible = models.CharField(blank=True, default='', max_length=120)
    physical_note = models.TextField(blank=True, default='')
