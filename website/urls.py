...
urlpatterns = [
    ...
    path("overig/hit/", role_required(ROLE_ADMIN, ROLE_PERFORMANCE, ROLE_TRAINER, allow_read_only_get=True)(views.hit_page), name="overig_hit"),
    path("aanwezigheden/", role_required(ROLE_ADMIN, ROLE_PERFORMANCE, ROLE_TRAINER, allow_read_only_get=True)(views.aanwezigheden_pagina), name="aanwezigheden"),
    path("aanwezigheden/update/<int:record_id>/", role_required(ROLE_ADMIN, ROLE_PERFORMANCE, ROLE_TRAINER)(views.aanwezigheden_update), name="aanwezigheden_update"),
